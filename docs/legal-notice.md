...
Operating exchanges, custody services, fiat on/off ramps, token offerings, or similar services **may** trigger licensing, registration, tax, sanctions, or consumer-protection obligations in some jurisdictions.

## Experimental software

Node software can contain bugs, including consensus bugs. Using it can result in loss of coins, splits, or failed transactions. There is no warranty; see the MIT license.

## Fair-launch intent (policy of this project)

The maintainers’ stated technical policy is: **no hidden developer premine**, genesis coinbase unspendable, coins enter circulation through mining after a documented launch. If that policy is ever changed, it must be documented before implementation — not after.

## Website and third parties

Any website at bitfuc.com is not a wallet backend. Do not send private keys to a website. Third-party explorers, casinos, or “DEX” pages can be wrong or malicious; verify with software you built from source.
