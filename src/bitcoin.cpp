...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        if (cmd.show_help || cmd.command.empty()) {
            ...
            args.emplace_back(UseMultiprocess(cmd) ? "bitfuc-node" : "bitfucd");
        } else if (cmd.command == "rpc") {
            args.emplace_back("bitfuc-cli");
